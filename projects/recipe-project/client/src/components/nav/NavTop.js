    ...
    return (
        <div className="nav-top">
            ...
            <nav className="nav-top__links">
                <Link className="nav-top__links--link" to="/">
                    Home
                </Link>
                <Link className="nav-top__links--link" to="/allrecipes">
                    All Recipes
                </Link>
                <Link className="nav-top__links--link" to="/conversions">
                    Conversions
                </Link>
                <Link className="nav-top__links--link" to="/about">
                    About
                </Link>
                {!isAuth && (
                    <>
                        <button
                            className="nav-top__links--link"
                            id="sign-up"
                ...
                <button
                    className="nav-top__links--link"
                    id="sign-up"
                    onClick={isAuth ? logout : () => setOpenSigninModal(true)}
                >
