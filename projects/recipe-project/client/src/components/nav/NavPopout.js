    ...
    return (
        <div className="nav-popout">
            <Link className="nav-logo" to="/">
                <img alt="dished online logo" src={logo} />
            </Link>
            <SearchBar />
            ...
            {showMenu && (
                <nav className="nav-popout__menu">
                    <div className="nav-popout__links">
                        <p>Pages</p>
                        <Link className="nav-popout__links--link" to="/">
                            Home
                        </Link>
                        <Link className="nav-popout__links--link" to="/allrecipes">
                            All Recipes
                        </Link>
                        <Link className="nav-popout__links--link" to="/conversions">
                            Conversions
                        </Link>
                        <Link className="nav-popout__links--link" to="/about">
                            About
                        </Link>
                    </div>
                    ...
                    <div className="nav-popout__links">
                        ...
                        {isAuth ? (
                            <>
                                <Link className="nav-popout__links--link" to="/myaccount">
                                    My Account
                                </Link>
                                <Link className="nav-popout__links--link" to="/myrecipes">
                                    My Recipes
                                </Link>
                                <Link
                                ...
                                <Link className="nav-popout__links--link" to={`/user?id=${user_id}`}>
                                    My Profile
                                </Link>
                                <li className="nav-popout__links--link" onClick={handleLogout}>
                                    Log Out
                                </li>
                            </>
                        ) : (
            ...
            <SignInModal
                ...
                handleCloseModal={() => setOpenSigninModal(false)}
            />
            <CreateAccountModal
