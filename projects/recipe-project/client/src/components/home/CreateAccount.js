        ...
        <div className="create-account">
            <div className="create-account__container">
                <div className="create-account__container--left">
                    ...
                    <p>
                        Browse and save all of your favorite recipes in one place. Search for ingredients,
                        category, or access 1000's of recipes from the comfort of your home or on your mobile
                        device.
                    </p>
                    {isAuth ? (
