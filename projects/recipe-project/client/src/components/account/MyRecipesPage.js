        ...
        <>
            ...
            <div className="columns">
                ...
                <div className="columns__center">
                    ...
                    <h2 className="columns__title" style={{ fontSize: 30 }}>
                    ...
                    {userRecipes.length < 1 && (
                        <>
                            ...
                            >
                                <Link className="button__link--Link" to="/submitrecipe">
                                    Submit a new recipe
                                </Link>
                            </button>
                        </>
                    ...
                    {userRecipes.length > 0 &&
                        userRecipes.map((recipe) => (
                            <div className="my-recipes" key={recipe._id}>
                                <h3 className="title center" style={{ fontSize: 30 }}>
                                    {recipe.title}
                                </h3>

                                <div className="my-recipes-buttons">
                                    <button className="button__link">
                                        <Link className="button__link--Link" to={`/recipe?id=${recipe._id}`}>
                                            View
                                        </Link>
                                    </button>
