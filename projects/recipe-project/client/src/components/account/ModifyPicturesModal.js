        ...
        >
                ...
                <div className="row center">
                    {props.pictures.map((pic) => (
                        <div key={pic._id} className="column">
                            ...
                            <input
                                name="radio-image"
                                onClick={() => setSelectedPicture(pic._id)}
                                type="radio"
                            />
                        </div>
                    ))}
            ...
            {!deleteConfirm ? (
                <div>
                    ...
                    <button
                        className="button"
                        onClick={() => deletePictures(selectedPicture)}
                    ...
                    <button className="button" onClick={isAuth && uploadPictures}>
                        Upload
                    </button>
                </div>
            ) : (
                <div>
                    ...
                    <button className="button" onClick={() => deletePictures('all')}>
                        Yes
                    </button>
                    <button className="button" onClick={() => setDeleteConfirm(false)}>
                        No
                    </button>
                </div>
            )}
