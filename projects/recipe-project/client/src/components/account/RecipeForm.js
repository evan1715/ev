...
const RecipeForm = (props) => {
    ...
    return (
        <div className="recipe-form">
            <label className="recipe-form__labels" htmlFor="recipe-title">
                Title for your recipe:
            </label>
            <input
            ...
            <label className="recipe-form__labels" htmlFor="cook-time">
                Total cook time to make the food:
            </label>
            <input
                className="modal__form--input"
                id="cook-time"
            ...
            <label className="recipe-form__labels" htmlFor="ingredients">
                Ingredients are entered as the amount, the measurement of it, and what the item is (ex:
                chicken):
            </label>
            ...
            <div className="recipe-form__added-ingredients">
                {ingredients.map((ingredient, index) => (
                    <li className="recipe-form__added-ingredients--list" key={index}>
                        ...
                        <button
                            className="button"
                            onClick={(e) => (e.preventDefault(), handleDeleteIngredient(index))}
                        >
                            Remove
                        </button>
                    </li>
            ...
            <form className="recipe-form__add-ingredients" onSubmit={(e) => handleAddIngredients(e)}>
                ...
                <input
                    ...
                    type="text"
                />
                <button className="button" title="Add ingredient" type="submit">
                    Add
                </button>
            </form>

            <label className="recipe-form__labels" htmlFor="description">
            ...
            <div className="recipe-form__buttons">
                <button className="button" onClick={handleCancel} title="Cancel">
                    Cancel
                </button>
                <button className="button" onClick={onSubmit} title="Submit">
                    Submit
                </button>
            </div>
        </div>
