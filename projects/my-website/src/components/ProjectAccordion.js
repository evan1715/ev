                ...
                {pjInfo.map((project, index) => (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="ps-2 text-muted">- {project.subtitle}</div>
                        </Accordion.Header>
                        ...
                        <Accordion.Body className="d-flex flex-column align-items-center">
                            ...
                            <section className="image-container text-center m-3">
                                <div>
                                    ...
                                    >
                                        ...
                                        {index === 3 &&
                                            myWebsite.map((image, inx) => (
                                                <Carousel.Item className="text-center" key={inx}>
                                                    <Image alt="screenshot of project" src={image} />
                                                </Carousel.Item>
                                            ))}
                                        {index === 4 &&
                                            taskManager.map((image, inx) => (
                                                <Carousel.Item className="text-center" key={inx}>
                                                    <Image alt="screenshot of project" src={image} />
                                                </Carousel.Item>
                                            ))}
                                        {index === 5 &&
                                            recipeProject.map((image, inx) => (
                                                <Carousel.Item className="text-center" key={inx}>
                                                    <Image alt="screenshot of project" src={image} />
                                                </Carousel.Item>
                                            ))}
                                        {index === 6 &&
                                            weatherApp.map((image, inx) => (
                                                <Carousel.Item className="text-center" key={inx}>
                                                    <Image alt="screenshot of project" src={image} />
                                                </Carousel.Item>
                                            ))}
                            ...
                            <section className="link-info" onClick={() => handleShow(index)}>
                                <div className="m-2 p-2">
                                    ...
                                    <Image alt="expand photos" height="20" src={expand} />
                                </div>
                            </section>
                            ...
                            <section className="d-flex mb-3">
                                {project.links[1] && (
                                    <a href={project.links[1]} rel="noreferrer" target="_blank">
                                        <span className="external-link nav-link">
                                            Source <Image alt="external link" src={external} />
                                        </span>
                                    </a>
                                )}
                                {project.links[2] && (
                                ...
                                {project.id === 'jdfix' && (
                                    <div className="d-flex justify-content-center">
                                        ...
                                        >
                                            <span className="external-link nav-link">
                                                JDFix <Image alt="external link" src={external} />
                                            </span>
                                        </a>
                                    </div>
                                )}
