        ...
        fetch('/api/mailer', {
            ...
            .then((res) => {
                if (res.ok) {
                    ...
                    console.log(res.status, 'Server response:', res);
                    setResponse(
                        'Email was unsuccessful. Try again. If problem persists, use another method of contact like LinkedIn.'
                    );
                }
            })
    ...
    return (
        <form className="form-contact" onSubmit={(e) => sendEmail(e)}>
            ...
            <div className="text-center">
                <button className="btn button-theme m-4 w-25" type="submit">
                    Submit
                </button>
            </div>
