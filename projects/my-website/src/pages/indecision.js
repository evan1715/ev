            ...
            <Container className={styles['indecision-master']}>
                ...
                <div className={styles['indecision-container']}>
                    ...
                    <div className={styles['widget']}>
                        ...
                        <div className={styles['widget-header']}>
                            ...
                            <button className={styles['button--link']} onClick={this.handleDeleteOptions}>
                                Remove All
                            </button>
                        </div>

                        {this.state.options.length === 0 && (
                            <p className={styles['widget__message']}>Add an option to get started.</p>
                        )}
                ...
                >
                    ...
                    {this.state.selectedOption && (
                        <p className={styles['modal__body']}>{this.state.selectedOption}</p>
                    )}
                    <button className={styles['indecision-button']} onClick={this.handleClearSelectedOption}>
                        Okay
                    </button>
                </Modal>
            </Container>
